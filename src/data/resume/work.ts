...
const work: Position[] = [
  ...
  },
  {
    ...
    highlights: [
      'Integrated Stripe Connect with Express Accounts to enable partner payouts — generated $35K in platform revenue and disbursed $28K to partners within the first month of launch.',
