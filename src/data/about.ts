...
If you think I can help with your project, or want to talk shop on backend architecture, distributed systems, fintech, or production AI/LLM engineering, then [reach out](/contact).
`;
